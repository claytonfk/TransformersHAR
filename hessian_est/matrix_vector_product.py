...
from .tensor_list_util import tensor_list_to_vector, vector_to_tensor_list
...
def _hessian_vector_product(
  ...
  """
  with tf.autodiff.ForwardAccumulator(primals=parameters, tangents=v) as acc:
...
def model_hessian_vector_product(
  ...
  v = vector_to_tensor_list(v, model.trainable_variables)
  ...
  mvp_as_list_of_tensors = _reduce_function_over_dataset(
      ...
      dataset,
      reduce_op=reduce_op)
  return tensor_list_to_vector(mvp_as_list_of_tensors)
